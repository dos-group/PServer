...
public class DistributedMatrix {
    ...
    private final DMatrix.MemoryLayout layout;
    ...
    public static void main(final String[] args) {
        ...
        final DistributedMatrix dm = new DistributedMatrix(10000, 10000, Partitioning.BLOCK_PARTITIONING, DMatrix.MemoryLayout.ROW_LAYOUT);
