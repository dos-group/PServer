...
public class Types {
    ...
    public static final class TypeInformation {
        ...
        public int getElementFieldOffset(final int elementIndex, final int fieldIndex) {
            return arrayElementTypeInfo != null ? getElementOffset(elementIndex) + arrayElementTypeInfo.getFieldOffset(fieldIndex) + (int)UnsafeOp.byteArrayOffset : -1;
        }

        public int getElementFieldOffset(final int elementIndex, final int[] fieldSelector) {
            return arrayElementTypeInfo != null ? getElementOffset(elementIndex) + arrayElementTypeInfo.getFieldOffset(fieldSelector) + (int)UnsafeOp.byteArrayOffset : -1;
        }
