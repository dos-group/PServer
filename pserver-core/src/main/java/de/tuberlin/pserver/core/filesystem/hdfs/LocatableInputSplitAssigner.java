...
public final class LocatableInputSplitAssigner implements InputSplitAssigner {
    ...
    public LocatableInputSplitAssigner(final FileInputSplit[] splits) {
    ...
    @Override
    public InputSplit getNextInputSplit(final MachineDescriptor md) { return getNextInputSplit(md.hostname); }
