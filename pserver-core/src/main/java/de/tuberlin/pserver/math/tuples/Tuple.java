...
public abstract class Tuple
        implements Serializable, Iterable<Object>, Comparable<Tuple> {
    ...
    private static int toByteArray0(final byte[] ba, int offset, final Tuple tuple) {
        ...
        for (final Object o : tuple) {
            if (o instanceof Tuple) {
                ...
                if (o instanceof Boolean) {
                    UnsafeOp.unsafe.putBoolean(ba, UnsafeOp.byteArrayOffset + offset, ((Boolean)o).booleanValue());
                    offset += Types.PrimitiveType.BOOLEAN.size;
                } else if (o instanceof Character) {
                    UnsafeOp.unsafe.putChar(ba, UnsafeOp.byteArrayOffset + offset, ((Character) o).charValue());
                    offset += Types.PrimitiveType.CHAR.size;
                } else if (o instanceof Byte) {
                    UnsafeOp.unsafe.putByte(ba, UnsafeOp.byteArrayOffset + offset, ((Byte) o).byteValue());
                    offset += Types.PrimitiveType.BYTE.size;
                } else if (o instanceof Short) {
                    UnsafeOp.unsafe.putShort(ba, UnsafeOp.byteArrayOffset + offset, ((Short) o).shortValue());
                    offset += Types.PrimitiveType.SHORT.size;
                } else if (o instanceof Integer) {
                    UnsafeOp.unsafe.putInt(ba, UnsafeOp.byteArrayOffset + offset, ((Integer) o).intValue());
                    offset += Types.PrimitiveType.INT.size;
                } else if (o instanceof Long) {
                    UnsafeOp.unsafe.putLong(ba, UnsafeOp.byteArrayOffset + offset, ((Long) o).longValue());
                    offset += Types.PrimitiveType.LONG.size;
                } else if (o instanceof Float) {
                    UnsafeOp.unsafe.putFloat(ba, UnsafeOp.byteArrayOffset + offset, ((Float) o).floatValue());
                    offset += Types.PrimitiveType.FLOAT.size;
                } else if (o instanceof Double) {
                    UnsafeOp.unsafe.putDouble(ba, UnsafeOp.byteArrayOffset + offset, ((Double) o).doubleValue());
