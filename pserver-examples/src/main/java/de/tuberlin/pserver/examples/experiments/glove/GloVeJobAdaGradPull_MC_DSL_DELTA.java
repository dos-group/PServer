...
import de.tuberlin.pserver.math.matrix.dense.DMatrixDeltaExtractor;
...
public class GloVeJobAdaGradPull_MC_DSL_DELTA extends JobExecutable {
    ...
    private Matrix W_previous;

    private DMatrixDeltaExtractor deltaExtractor;
    ...
    public void prologue() {
        ...
        W_previous = createMatrix(Matrix.Format.DENSE_MATRIX);
        ...
        final DMatrixDeltaExtractor.DeltaFilter deltaFilter = (i, j, o, n ) -> {
            double sn = n * 10000;
            double so = o * 10000;
            double d = sn > 0 ? sn : 1;
            return ((so - sn) / d) > 0.3;
        ...
        deltaExtractor = new DMatrixDeltaExtractor((DMatrix)W, (DMatrix)W_previous, deltaFilter);
    ...
    public static void main(final String[] args) {
        ...
        PServerExecutor.LOCAL
                .run(GloVeJobAdaGradPull_MC_DSL_DELTA.class, 1)
                .done();
    }
}