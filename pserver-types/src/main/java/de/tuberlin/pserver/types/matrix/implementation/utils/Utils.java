package de.tuberlin.pserver.types.matrix.implementation.utils;

import com.google.common.base.Preconditions;
import de.tuberlin.pserver.types.matrix.implementation.Matrix32F;
import de.tuberlin.pserver.types.matrix.implementation.utils.exceptions.IncompatibleShapeException;

public class Utils {

    public static final double DEFAULT_EPSILON = 0.001;

    public static long getPos(final long row, final long col, Matrix32F mat) {
     ...
     */
    public static void checkShapeEqual(Matrix32F A, Matrix32F B) {
     ...
     */
    public static void checkShapeEqual(Matrix32F A, Matrix32F B, Matrix32F C) {
     ...
     * @return true iff n == o
     */
    public static boolean shapeMul2(Matrix32F A, Matrix32F B) {
     ...
     */
    public static void checkShapeMatrixMatrixMult(Matrix32F A, Matrix32F B, Matrix32F C) {
     ...
     */
    public static void checkShapeSquare(Matrix32F A) {
        if( ! (A.rows() == A.cols())) {
     ...
     */
    public static void checkShapeTranspose(Matrix32F A, Matrix32F B) {
     ...
     */
    public static void checkApplyVectorToRows(Matrix32F A, Matrix32F V, Matrix32F B) {
     ...
     */
    public static void checkApplyVectorToCols(Matrix32F A, Matrix32F V, Matrix32F B) {
     ...
     */
    public static void checkDotProduct(Matrix32F A, Matrix32F B) {
        if( ! (A.rows() == B.rows() && A.cols() == B.cols())) {
