...
public class NoSessionAvgDenseMatrix64F extends AbstractCRDTMatrix implements Matrix64F, AvgMatrix64F {
    ...
    public NoSessionAvgDenseMatrix64F(long rows, long cols, String id, int noOfReplicas, ProgramContext programContext) {
