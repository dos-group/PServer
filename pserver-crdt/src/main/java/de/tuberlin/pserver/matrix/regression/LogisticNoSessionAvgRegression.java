package de.tuberlin.pserver.matrix.regression;
...
import de.tuberlin.pserver.matrix.crdt.NoSessionAvgDenseMatrix32F;
...
public class LogisticNoSessionAvgRegression extends Program {
    ...
    public NoSessionAvgDenseMatrix32F W;
    ...
    public void unit(Lifecycle lifecycle) {
        ...
        W = new NoSessionAvgDenseMatrix32F(1, D, "weight", Integer.parseInt(NUM_NODES), programContext);
        ...
        lifecycle.process(() -> {
            ...
            System.out.println("[DEBUG] Node " + programContext.runtimeContext.nodeID + " Weight vector: ");
            for (int i = 0; i < W.rows(); i++) {
                System.out.println();
                for (int k = 0; k < W.cols(); k++) {
                    System.out.print(W.get(i, k) + " ");
                }
            }
            System.out.println();
