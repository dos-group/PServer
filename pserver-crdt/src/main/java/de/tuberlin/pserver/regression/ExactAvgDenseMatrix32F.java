...
public class ExactAvgDenseMatrix32F extends AbstractCRDTMatrix implements AvgMatrix32F, Serializable {
    ...
    public ExactAvgDenseMatrix32F(long rows, long cols, String id, int noOfReplicas, ProgramContext programContext) {
    ...
    public String toString() {
        ...
        stringBuilder.append("ExactAvgDenseMatrix32F["+rows+"|"+cols+"]: ");
    ...
    private boolean makeAverage(long row, long col, Float value) {
        ...
        if(counts.get(row, col).equals(noOfReplicas)) {
