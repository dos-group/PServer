...
public class LogisticExactAvgRegression extends Program {
    ...
    public ExactAvgRegressionDenseMatrix32F W;
    ...
    public void unit(Lifecycle lifecycle) {
        ...
        W = new ExactAvgRegressionDenseMatrix32F(1, D, "weight", Integer.parseInt(NUM_NODES), programContext);
    ...
    private static void local() {
        ...
        PServerExecutor.LOCAL
                .run(LogisticExactAvgRegression.class)
                //.results(result)
                .done();
