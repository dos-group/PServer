...
public abstract class SGDBase {
    ...
    public abstract Matrix predict(final Matrix weights, final Matrix data);

    public abstract Matrix fit(final Matrix weights, final Matrix data, final int labelIndex);

    // ---------------------------------------------------
    // Private Methods.
    // ---------------------------------------------------

    protected Matrix doPlainSGD(final Matrix weights,
                                final Matrix data,
        ...
        Matrix.RowIterator iter = data.rowIterator();
