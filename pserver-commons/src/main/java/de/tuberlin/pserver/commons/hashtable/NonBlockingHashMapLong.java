...
public class NonBlockingHashMapLong<TypeV>
  ...
  // Pick partitionSize 16 K/V pairs, which turns into (16*2)*4+12 = 140 bytes on a
  ...
  // Constructors
  /** Create a new NonBlockingHashMapLong with default minimum partitionSize (currently set
   ...
   *  an appropriate partitionSize.  Large numbers here when used with a small count of
  ...
  /** Create a new NonBlockingHashMapLong, setting both the initial partitionSize and
  ...
  private static final class CHM<TypeV> implements Serializable {
    ...
    private final CHM resize() {
      ...
      //System.out.println("old="+oldlen+" new="+newsz+" partitionSize()="+sz+" est_slots()="+q+" millis="+(tm-_nbhml._last_resize_milli));
